...
namespace NetOff
{
    class SimulationClient
    {
     public:
        ...
        VariableList getVariableNames(const int & simId);
         ...
         *  @arg outputs VariableList containing all variables the client sends to the server. The order determines the order in the input ValueContainer.
         ...
         */
        ValueContainer & initializeSimulation(const int & simId, const VariableList & outputs, const VariableList & inputs,
                                                          const double * inputsReal = nullptr, const int * inputsInt = nullptr, const char * inputsBool =
                                                                  nullptr);
     ...
     private:
        ...
        {
            auto answer = _netClient.variableRecv();
